            ...
            case "rackoverview": {
                ...
                for (var v = 0; v < unsafeData.prodNameSort[0].length; v++) {
                    ...
                    if (showProduct) {
                        ...
                        if (bestand.length > 1) {
                            createElement("td", { "style": "text-align:right;" + (FARMNR == farm ? "background-color:#CCCCFF;" : (zCount % 2 == 0 ? "background-color:#eeeeee;" : "")) }, newtr, (w > 0 ? numberFormat(sum) + "<br>" + numberFormat(sum5) : numberFormat(sum)));
                        }
                    }
                }
...
var LNG = "";
function do_main() {
    var TOOLTIP = $top("divToolTip");
    var LOG_BUBBLE_BOX = $top("divLogBubbleBox");
