...
String.prototype.reverse = function () {
    try {
        ...
        GM_logError("String.prototype.reverse", "", "", err);
    }
};
String.prototype.capitalize = function () {
    try {
        ...
        GM_logError("String.prototype.capitalize", "", "", err);
    }
};
Array.prototype.contains = function (searchElement) {
    try {
        ...
        GM_logError("Array.prototype.contains", "", "", err);
    }
};
Array.prototype.equals = function (that) {
    try {
        ...
        GM_logError("Array.prototype.equals", "", "", err);
    }
};
Array.prototype.shuffle = function () {
    try {
        ...
        GM_logError("Array.prototype.shuffle", "", "", err);
    }
};
Array.prototype.swap = function (from, to) {
    try {
        ...
        GM_logError("Array.prototype.swap", "from, to", "", err);
    }
};
Object.prototype.equals = function (that) {
    try {
        ...
        GM_logError("Object.prototype.equals", "", "", err);
    }
};
...
Object.prototype.sortObj = function (sortfkt, descending) {
    ...
    try {
        ...
        GM_logError("Object.prototype.sortObj", "", "", err);
    }
};
Object.prototype.isEmpty = function () {
    try {
        ...
        GM_logError("Object.prototype.isEmpty", "", "", err);
    }
};
Object.prototype.length = function () {
    try {
        ...
        GM_logError("Object.prototype.length", "", "", err);
    }
};
Object.prototype.clone = function () {
    try {
        ...
        GM_logError("Object.prototype.clone", "", "property=" + property, err);
    }
};
// FUNCTIONS *************************************************************************************************************
function GM_setValueCache(name, value, debugName) {
    try {
        ...
        GM_logError("GM_setValueCache", "name=" + name + " debugName=" + debugName, "", err);
    }
}
...
function GM_logInfo(name, parameters, variables, text, type) {
    try {
        if ((undefined === type) || OPTION_LOGGING[type]) {
            ...
            // console.trace();
            if (DEVMODE_LOG_INFO) {
                logBubble.add(text, 10);
            }
        }
    }
    catch (err) {
        GM_logError("GM_logInfo", "name=" + name + " parameters=" + parameters + " variables=" + variables + " text=" + text, "", err);
    }
}
;
function GM_logWarning(name, parameters, variables, text) {
    try {
        ...
        console.trace();
        if (DEVMODE_LOG_WARNING) {
            logBubble.add(text, 10, "orange");
        }
    }
    catch (err) {
        GM_logError("GM_logWarning", "name=" + name + " parameters=" + parameters + " variables=" + variables + " text=" + text, "", err);
    }
}
;
function GM_logError(name, parameters, variables, text) {
    try {
        ...
        console.trace();
        if (DEVMODE_LOG_ERROR) {
            logBubble.add(text, 10, "red");
        }
    }
    catch (err) {
        console.log("ERROR in 'GM_logError'\nname=" + name + "\n" + err);
    }
}
;
/*
...
function unsafe$top(ID) {
    try {
        ...
        GM_logError("unsafe$top", "ID=" + ID, "", err);
    }
}
function containerId(node) {
    try {
        ...
        GM_logError("containerId", "node.id=" + (node && node.id ? node.id : "?"), "", err);
    }
}
function removeElement(node) {
    try {
        ...
        GM_logError("removeElement", "node.id=" + (node && node.id ? node.id : "?"), "", err);
    }
}
function createElement(type, attributes, append, inner) {
    try {
        ...
        GM_logError("createElement", "type=" + type + " attributes=" + JSON.stringify(attributes) + " append=" + append + " append.id=" + (append && append.id ? append.id : "?"), "", err);
    }
}
function unsafeCloneObject(obj) {
    try {
        ...
        GM_logError("unsafeCloneObject", "", "", err);
    }
}
function unsafeOverwriteFunction(fooName, newFoo, optional) {
    try {
        ...
        GM_logError("unsafeOverwriteFunction", "fooName=" + fooName, "", err);
    }
}
;
function unsafeOverwriteObjFunction(fooObj, fooName, newFoo, optional) {
    try {
        ...
        GM_logError("unsafeOverwriteObjFunction", "fooObj" + fooObj + " fooName=" + fooName, "", err);
    }
}
;
function raiseEvent(name) {
    try {
        ...
        GM_logError("raiseEvent", "name=" + name, "", err);
    }
}
function raiseEventTop(name) {
    try {
        ...
        if ((PAGE != "main") && (self == top)) {
            window.setTimeout(function () {
                if (DEVMODE_EVENTS) {
                    logBubble.add("raiseEventTop set " + name);
                }
            ...
            if (DEVMODE_EVENTS) {
                logBubble.add("raiseEventTop " + name);
            }
        ...
        GM_logError("raiseEventTop", "name=" + name, "", err);
    }
}
function click(node) {
    try {
...
function timeMeasureStart(str) {
    try {
        ...
        GM_logError("timeMeasureStart", "str=" + str, "", err);
    }
}
function timeMeasureStop(str) {
    try {
        ...
        GM_logError("timeMeasureStop", "str=" + str, "", err);
    }
}
//---------------------------------------------------------------------------------------------------------------------------
function getElementLeft(id, toElem) {
    try {
        ...
        GM_logError("getElementLeft", "id=" + id, "", err);
    }
}
function getElementTop(id, toElem) {
    try {
        ...
        GM_logError("getElementTop", "id=" + id, "", err);
    }
}
...
function getTimeStr(time, hideSeconds) {
    ...
    try {
        ...
        GM_logError("getTimeStr", "time=" + time + " hideSeconds=" + hideSeconds, "", err);
    }
}
...
function getTime(str) {
    try {
        ...
        GM_logError("getTime", "str=" + str, "", err);
    }
}
/*
...
function getFormattedTime(str) {
    try {
        ...
        GM_logError("getFormattedTime", "str=" + str, "", err);
    }
}
//TODO name? getDaytime, time2daytime
function getDaytimeStr(time, hideSeconds, paddHours) {
    try {
        ...
        GM_logError("getDaytimeStr", "time=" + time + " hideSeconds=" + hideSeconds + " paddHours=" + paddHours, "", err);
    }
}
/*
...
function getDateStr(time, yearformat, padd) {
    // yearformat:
    // 0 -> 01.02.
    // 1 -> 01.02.11
    ...
    // false -> 1.2.2011
    try {
        if (typeof yearformat != "number") {
            yearformat = 2;
        }
        if (typeof padd != "boolean") {
            padd = true;
        }
        var time2 = new Date(time * 1000);
        var str, help;
        ...
        GM_logError("getDateStr", "time=" + time + " yearformat=" + yearformat + " padd=" + padd, "", err);
    }
}
    ...
    try {
        ...
        switch (yearformat) {
            case 0:
                ...
                break;
            case 1:
                str = dateFormatDMY.replace("year", time2.getFullYear().toString().slice(-2));
                break;
            case 2:
                str = dateFormatDMY.replace("year", time2.getFullYear().toString());
                break;
        }
        help = time2.getDate();
        str = str.replace("day", ((padd && help < 10) ? "0" : "") + help);
        ...
        GM_logError("getFormattedDateStr", "time=" + time + " yearformat=" + yearformat + " padd=" + padd, "", err);
    }
}
//TODO name? getDateText
function getDateText(time, yearformat) {
    try {
        ...
        GM_logError("getDateText", "time=" + time + " yearformat=" + yearformat, "", err);
    }
}
function countDays(time1, time2) {
    ...
    try {
        ...
        GM_logError("countDays", "time1=" + time1 + " time2=" + time2, "", err);
    }
}
//---------------------------------------------------------------------------------------------------------------------------
...
function enc(str, sh) {
    try {
        ...
        GM_logError("enc", "str=" + str + " sh=" + sh, "", err);
    }
}
...
function Log(obj, pre) {
    try {
        ...
        GM_logError("Log", "obj=" + obj + " pre=" + pre, "", err);
    }
}
//---------------------------------------------------------------------------------------------------------------------------
...
function moneyFormat(number) {
    try {
        ...
        GM_logError("moneyFormat", "number=" + number, "", err);
    }
}
function moneyFormatInt(number) {
    try {
        ...
        GM_logError("moneyFormatInt", "number=" + number, "", err);
    }
}
function moneyFormatLimit(number, limit) {
    try {
        ...
        GM_logError("moneyFormatLimit", "number=" + number + " limit=" + limit, "", err);
    }
}
function pointsFormat(number, containertype, append) {
    try {
        ...
        GM_logError("pointsFormat", "number=" + number + " containertype=" + containertype, "", err);
    }
}
function coinsFormat(number, append) {
    try {
        ...
        GM_logError("coinsFormat", "number=" + number, "", err);
    }
}
    ...
    try {
        if (unsafeWindow.forestry_user_buildings != undefined && pos != undefined) {
            for (var building in unsafeWindow.forestry_user_buildings) {
                if (!unsafeWindow.forestry_user_buildings.hasOwnProperty(building)) {
                    continue;
                }
        ...
        GM_logError("coinsFormat", "pos=" + pos, "", err);
    }
}
//---------------------------------------------------------------------------------------------------------------------------
function getRandom(min, max) {
    try {
        ...
        GM_logError("getRandom", "min=" + min + " max=" + max, "", err);
    }
}
function compareVersions(version1, version2) {
    ...
    try {
        ...
        GM_logError("compareVersions", "version1=" + version1 + " version2=" + version2, "", err);
    }
}
function alert2(text, yesText, noText, yesFkt, noFkt) {
    try {
        ...
        GM_logError("alert2", "text=" + text + " yesText=" + yesText + " noText=" + noText, "", err);
    }
}
// CONSTANTS / GLOBALS ************************************************************************************************
/**
...
// Objects ************************************************************************************************************
try {
    if (!unsafeWindow.greaseMonkeyData) {
        createObjectIn(unsafeWindow, { defineAs: "greaseMonkeyData" });
    }
    var unsafeData = unsafeWindow.greaseMonkeyData;
}
catch (err) {
    GM_logError("unsafeData", "", "location.href=" + location.href, err);
}
try {
    if (!top.window.wrappedJSObject.greaseMonkeyData) {
        createObjectIn(top.window.wrappedJSObject, { defineAs: "greaseMonkeyData" });
    }
    top.unsafeData = top.window.wrappedJSObject.greaseMonkeyData;
}
catch (err) {
    GM_logError("top.unsafeData", "", "location.href=" + location.href, err);
}
        ...
        try {
            ...
            this.mousemove = function (event) {
                try {
                    ...
                    GM_logError("toolTip.mousemove", "event=" + event, "", err);
                }
            };
            this.init = function () {
                try {
            ...
            this.show = function (event, content) {
                try {
                    ...
                    GM_logError("toolTip.show", "event=" + event, "", err);
                }
            };
            this.adjust = function (targetElem) {
                try {
                    ...
                    GM_logError("toolTip.adjust", "", "", err);
                }
            };
            this.hide = function () {
                try {
                    ...
                    GM_logError("toolTip.hide", "", "", err);
                }
            };
        }
        catch (err) {
            GM_logError("toolTip", "", "", err);
        }
    };
        ...
        try {
                    ...
                    if ((!container) && ALL) {
                        ...
                        container.addEventListener("mouseover", function (event) {
                            try {
                                ...
                                GM_logError("logBubble.mouseOver", "event=" + event, "", err);
                            }
                        }, false);
                        container.addEventListener("mouseout", function (event) {
                            try {
                                ...
                                GM_logError("logBubble.mouseOut", "event=" + event, "", err);
                            }
                        }, false);
                    }
                }
                catch (err) {
                    GM_logError("logBubble.init", "", "", err);
                }
            };
            this.add = function (text, timer, color) {
                try {
                    ...
                    GM_logError("logBubble.add", "text=" + text, "", err);
                }
            };
            this.clear = function () {
                try {
                    ...
                    GM_logError("logBubble.clear", "", "", err);
                }
            };
            this.test = function () {
                try {
                    ...
                    GM_logError("logBubble.test", "", "", err);
                }
            };
        }
        catch (err) {
            GM_logError("logBubble", "", "", err);
        }
    };
        ...
        try {
            ...
            this.init = function (skriptName) {
                try {
                    ...
                    GM_logError("tracking.init", "skriptName=" + skriptName, "", err);
                }
            };
            this.start = function (skriptName, functionName, parameterArray) {
                try {
                    ...
                    GM_logError("tracking.start", "skriptName=" + skriptName + " functionName=" + functionName, "", err);
                }
            };
            this.end = function (skriptName, trackingHandle) {
                try {
                    ...
                    GM_logError("tracking.end", "skriptName=" + skriptName, "", err);
                }
            };
...
function getText(id, noWarning) {
    try {
        if (text[LANGUAGE] && text[LANGUAGE][id]) {
            ...
            if (!noWarning) {
                GM_logWarning("getText", "id=" + id, "LANGUAGE=" + LANGUAGE, "Text not found.");
            }
            return "";
        }
    }
    catch (err) {
        GM_logError("getText", "id=" + id + " noWarning=" + noWarning, "", err);
    }
}
var delimThou = ".";
...
var NEVER = 2147483000; //upper limit of signed long
// ON LOAD ***************************************************************************************************************
function startScript() {
    try {
        ...
        GM_logError("startScript", "", "location.href=" + location.href, err);
    }
}
