...
// Take the following from the game ***********************************************************************************
    if(undefined===text[LANGUAGE]){
        ...
        text[LANGUAGE]["msgContentMarketsale"]="(.*) k"+o_dots+"pte (\\d+) st (.*?) f"+o_dots+"r<br>\\s*(.*?) dlr av dig\\.";
        // *************
        ...
        text[LANGUAGE]["msgContentContractsale"]="(.*) har signerat ett av dina kontrakt!<br><br>\\s*F"+o_dots+"ljande produkter har s"+a_ring+"lts:<br>([\\S\\s]*)\\s*<br>\\s*Kontraktsbeloppet (.*?) dlr har krediterats ditt konto\\.";
...
// And all the other texts you can enter what you want ****************************************************************
        ...
        text[LANGUAGE]["automat_settings_donating"] = " to donate";
        text[LANGUAGE]["automat_settings_gambling"] = " to gamble";
