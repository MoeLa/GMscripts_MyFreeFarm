    ...
    try{
        ...
        if(bot.isActive()){
            ...
            if ((settings.get("account","botUseIceDelivery"))&&($("deliveryevent_link"))){
                if ((unsafeWindow.deliveryevent) &&
                    ( !unsafeWindow.deliveryevent.data.data.tour || (unsafeWindow.deliveryevent.data.data.tour.remain<=0) ) &&
                    (unsafeWindow.deliveryevent.data.data.points>=unsafeWindow.deliveryevent.data.config.spots.playground.points)
                )   {
...
var settings=new function(){
    ...
    var dataDefault={"global":{},
                     ...
                     "account":{"autoPlant":true,"autoWater":true,"autoFeed":true,"botUseClothingDonation":false,"botUsebuyPetsParts":false,"botUseClothingGamble":false,"botUseDonkey":false,"botUseFarmersmarket":false,"botUseVetTreatment":true,"botUseFarmi":false,"botUseFoodworld":false,"botUseForestry":false,"botUseGuildJop":false,"botUseIceDelivery":false,"botUseLottery":false,"botUseMegafield":false,"botUseOlympiaRun":false,"botPreferMegafield":true,"botUseMegafieldPremiumPlanting":true,"megafieldSmallVehicle":1,"megafieldBigVehicle":0,"botUseWindmill":false,"disableCropFields":false,"farmiAccept":false,"farmiAcceptAboveNr":100,"farmiAcceptBelowMinValue":false,"botUseFarmiFoodworld":true,"farmiReject":false,"farmiRejectUntilNr":90,"farmiRemoveMissing":false,"farmiRemoveMissingAboveNr":10,"lotteryActivate":false,"lotteryDailyLot":false,"powerUpActivate":false,"seedWaitForCrop":30,"showQueueTime":true,"useQueueList":false}
                    };
    var require=    {"global":{},
                     "country":{},
                     "server":{},
