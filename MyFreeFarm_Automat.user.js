...
const neededVersionBerater="2.5.12b";
...
try{
    ...
    if(bot.checkRun("autoFarmPlant",runId,!isBot)){
        ...
        if(v<121){
            if((unsafeData.prodTyp[0][unsafeWindow.selected]=="v")&&unsafeData.prodStock[farm][unsafeWindow.selected]&&unsafeData.prodStock[farm][unsafeWindow.selected]>0){
