...
// Take the following from the game ***********************************************************************************
    if(undefined===text[LANGUAGE]){
        ...
        text[LANGUAGE]["msgSubjectMarketsale"]="^Targ&nbsp;.+ ft&nbsp;\(.+x .+\)$";
        ...
        // - The subject.
        text[LANGUAGE]["msgSubjectContractsale"]="Umowa została podpisana";
        // - The content: The text where the general information is stated. The information has to be replaced by "(.+?)".
        text[LANGUAGE]["msgContentContractsale"]="(.+) podpisał wysłaną mu przez Ciebie umowę!<br>\\s*<br>\\s*Sprzedałeś następujące produkty:\\s*<br>\\s*(<.+?)<br>\\s*Należność za produkty w wysokości (.+?)&nbsp;ft została przelana na Twoje konto\\.";
        // - The line-pattern for the detailed selling list (equals the replaced information above).
        text[LANGUAGE]["msgContentContractsaleList"]=".+?(\\d+)x\\s*(.+?)<";
        // - A contract which was sent to you was canceld before you were able to accept it
        text[LANGUAGE]["msgSubjectContractCancel"]="Umowa została odrzucona";
        // *************
...
// And all the other texts you can enter what you want ****************************************************************
        ...
        text[LANGUAGE]["confirmChangelogVersion"]="Zainstalowałeś nową wersję skryptu Doradcy.<br>Wersja %1% zawiera poniższe zmiany:";
        ...
        text[LANGUAGE]["overNPCprice"] = "więcej niż w sklepie";
        text[LANGUAGE]["overview"] = "Przegląd";
        text[LANGUAGE]["overX"] = "więcej %1%";
        text[LANGUAGE]["pageXNotLoaded"]="Strona '%1%' nie jest załadowana w całości.";
        ...
        text[LANGUAGE]["reloadInXSec"]="Przeładowanie za %1% s.";
        ...
        text[LANGUAGE]["wateringFeature"] = "Maszyna nawadniająca";
        ...
        text[LANGUAGE]["category_fl"]="Kwiaty";
        text[LANGUAGE]["category_fla"]="Arrangements";
        text[LANGUAGE]["category_hr"]="Zioła lecznicze";
        ...
        text[LANGUAGE]["category_p0"]="Power-Upy - produkty";
        text[LANGUAGE]["category_p1"]="Power-Upy - zwiększające wydajność";
        text[LANGUAGE]["category_p2"]="Power-Upy - dające punkty";
        // settings
      ...
      text[LANGUAGE]["settings_valFoodworldFarmiPlacing"]=["Obsługa klientów strefy pikniku","Klienci stefy pikniku będą automatycznie umieszczani na wolnych miejscach."]; 
        ...
        //title
        text[LANGUAGE]["automat_title_on_general"] = "Pokaż tylko Listę Główną<br>+Ctrl: Pokaż Listę Główną";
        text[LANGUAGE]["automat_title_off_general"] = "Pokaż tylko Listę Główną<br>+Ctrl: Schowaj Listę Główną";
